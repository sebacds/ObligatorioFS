...
import { crearMascota, obtenerMascotaPorId, obtenerMascotasPropias, obtenerMascotasPorPropietario, editarMascota, eliminarMascota } from '../../controllers/mascota-controller.mjs';
...
import validarRolMiddleware from '../../middlewares/rol-middleware.mjs';
...
routes.get('/mis-mascotas', obtenerMascotasPropias);
...
routes.get('/propietario/:id', validarRequest(validarObtenerMascotasPorPropietario, reqValidate.PARAMS), obtenerMascotasPorPropietario);
